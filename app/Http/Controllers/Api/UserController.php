        ...
        return response()->json(
            [
                ...
                "result" => [
                    ...
                    "status" => 1,
                    "telephone" => "",
                    "lastLoginIp" => "27.154.74.117", "lastLoginTime" => 1534837621348, "creatorId" =>
                        "admin", "createTime" => 1497160610259, "merchantCode" => "TLif2btpzg079h15bk",
                    "deleted" => 0, "roleId" => "admin",
                    "role" => [
                        "id" => "admin",
                        "name" => "管理员",
                        "describe" => "拥有所有权限",
                        ...
                        "deleted" => 0, "permissions" => [
                            ...
                            ["roleId" => "admin", "permissionId" => "result",
                                "permissionName" => "结果权限",
